    ...
    <script>
        ...
        function createNewItem() {
            ...
            var item = '<div class="row item-set">\n' +
                ...
                '                        <div class="form-group">\n' +
                '                            <input type="text" class="form-control serial_code" id="product_code' + rnd + '"\n' +
            ...
            $(`#product_code${rnd}`).focus();
            $(`#product_code${rnd}`).on('keyup', function (e) {
                if (e.keyCode == 13) {
                    e.preventDefault();
        ...
        $('#submit-button').click(function () {
            ...
            rndList.forEach((rnd) => {
                var product_code = $(`#product_code${rnd}`).val();
                var serial_code = $(`#serial_code${rnd}`).val();

                itemList.push({product_code: product_code, serial_code: serial_code})
            })
            ...
            $.ajax({
                ...
                success: function (data) {
                    console.log(data)
                    if (data['status'] == 200) {
                        $.notify("Stock out Successfully", "success");
                        location.reload();
                    } else {
